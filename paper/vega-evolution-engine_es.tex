...
\title{VEGA Evolution Engine: Un Marco Conceptual}
...
\begin{abstract}
Este trabajo introduce VEGA Evolution Engine como un nuevo marco conceptual dentro del paradigma Resonance Data y QIRC.
\end{abstract}
