...
\title{VEGA Evolution Engine: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA Evolution Engine'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
