...
\title{VEGA Evolution Engine: Концептуальная основа}
...
\begin{abstract}
Эта работа представляет VEGA Evolution Engine как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
\end{abstract}
